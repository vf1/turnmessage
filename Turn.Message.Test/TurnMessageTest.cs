...
namespace TestTurnMessage
{
	...
	public class TurnMessageTest
	{
		...
		[Test()]
		public void Parse_With_Data_Offset_In_Array()
		{
			byte[] bytes = new byte[]
			{
				0xFF, 0xFF, 0xFF, 0xFF, // }
			...
			TurnMessage message = TurnMessage.Parse(bytes, 40, bytes.Length - 40, TurnMessageRfc.MsTurn);

			Assert.IsNotNull(message.MessageIntegrity);
			Assert.AreEqual(message.MessageIntegrity.ValueLength, 0x14);
		}
